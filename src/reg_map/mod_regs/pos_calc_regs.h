/*
  ...
  * Created        : Tue Jan 14 09:53:43 2014
  * Standard       : ANSI C
...
#define POS_CALC_REG_DS_TBT_THRES (0x00000000 << WB_GR_SHIFT)
/* [0x4]: REG Config divisor threshold FOFB register */
#define POS_CALC_REG_DS_FOFB_THRES (0x00000001 << WB_GR_SHIFT)
/* [0x8]: REG Config divisor threshold Monit. register */
#define POS_CALC_REG_DS_MONIT_THRES (0x00000002 << WB_GR_SHIFT)
/* [0xc]: REG BPM sensitivity (X axis) parameter register */
#define POS_CALC_REG_KX (0x00000003 << WB_GR_SHIFT)
/* [0x10]: REG BPM sensitivity (Y axis) parameter register */
#define POS_CALC_REG_KY (0x00000004 << WB_GR_SHIFT)
/* [0x14]: REG BPM sensitivity (Sum) parameter register */
#define POS_CALC_REG_KSUM (0x00000005 << WB_GR_SHIFT)
/* [0x18]: REG DSP TBT incorrect TDM counter */
#define POS_CALC_REG_DSP_CTNR_TBT (0x00000006 << WB_GR_SHIFT)
/* [0x1c]: REG DSP FOFB incorrect TDM counter */
#define POS_CALC_REG_DSP_CTNR_FOFB (0x00000007 << WB_GR_SHIFT)
/* [0x20]: REG DSP Monit. incorrect TDM counter part 1 */
#define POS_CALC_REG_DSP_CTNR1_MONIT (0x00000008 << WB_GR_SHIFT)
/* [0x24]: REG DSP Monit. incorrect TDM counter part 2 */
#define POS_CALC_REG_DSP_CTNR2_MONIT (0x00000009 << WB_GR_SHIFT)
/* [0x28]: REG DSP error clearing */
#define POS_CALC_REG_DSP_ERR_CLR (0x0000000a << WB_GR_SHIFT)
/* [0x2c]: REG DDS general config registers for all channels */
#define POS_CALC_REG_DDS_CFG (0x0000000b << WB_GR_SHIFT)
/* [0x30]: REG DDS phase increment parameter register for channel 0 */
#define POS_CALC_REG_DDS_PINC_CH0 (0x0000000c << WB_GR_SHIFT)
/* [0x34]: REG DDS phase increment parameter register for channel 1 */
#define POS_CALC_REG_DDS_PINC_CH1 (0x0000000d << WB_GR_SHIFT)
/* [0x38]: REG DDS phase increment parameter register for channel 2 */
#define POS_CALC_REG_DDS_PINC_CH2 (0x0000000e << WB_GR_SHIFT)
/* [0x3c]: REG DDS phase increment parameter register for channel 3 */
#define POS_CALC_REG_DDS_PINC_CH3 (0x0000000f << WB_GR_SHIFT)
/* [0x40]: REG DDS phase offset parameter register for channel 0 */
#define POS_CALC_REG_DDS_POFF_CH0 (0x00000010 << WB_GR_SHIFT)
/* [0x44]: REG DDS phase offset parameter register for channel 1 */
#define POS_CALC_REG_DDS_POFF_CH1 (0x00000011 << WB_GR_SHIFT)
/* [0x48]: REG DDS phase offset parameter register for channel 2 */
#define POS_CALC_REG_DDS_POFF_CH2 (0x00000012 << WB_GR_SHIFT)
/* [0x4c]: REG DDS phase offset parameter register for channel 3 */
#define POS_CALC_REG_DDS_POFF_CH3 (0x00000013 << WB_GR_SHIFT)
/* [0x50]: REG Monit. Amplitude Value for channel 0 */
#define POS_CALC_REG_DSP_MONIT_AMP_CH0 (0x00000014 << WB_GR_SHIFT)
/* [0x54]: REG Monit. Amplitude Value for channel 1 */
#define POS_CALC_REG_DSP_MONIT_AMP_CH1 (0x00000015 << WB_GR_SHIFT)
/* [0x58]: REG Monit. Amplitude Value for channel 2 */
#define POS_CALC_REG_DSP_MONIT_AMP_CH2 (0x00000016 << WB_GR_SHIFT)
/* [0x5c]: REG Monit. Amplitude Value for channel 3 */
#define POS_CALC_REG_DSP_MONIT_AMP_CH3 (0x00000017 << WB_GR_SHIFT)
/* [0x60]: REG Monit. X Position Value */
#define POS_CALC_REG_DSP_MONIT_POS_X (0x00000018 << WB_GR_SHIFT)
/* [0x64]: REG Monit. Y Position Value */
#define POS_CALC_REG_DSP_MONIT_POS_Y (0x00000019 << WB_GR_SHIFT)
/* [0x68]: REG Monit. Q Position Value */
#define POS_CALC_REG_DSP_MONIT_POS_Q (0x0000001a << WB_GR_SHIFT)
/* [0x6c]: REG Monit. Sum Position Value */
#define POS_CALC_REG_DSP_MONIT_POS_SUM (0x0000001b << WB_GR_SHIFT)

///* [0x0]: REG Config divisor threshold TBT register */
//#define POS_CALC_REG_DS_TBT_THRES 0x00000000
///* [0x4]: REG Config divisor threshold FOFB register */
//#define POS_CALC_REG_DS_FOFB_THRES 0x00000001
///* [0x8]: REG Config divisor threshold Monit. register */
//#define POS_CALC_REG_DS_MONIT_THRES 0x00000002
///* [0xc]: REG BPM sensitivity (X axis) parameter register */
//#define POS_CALC_REG_KX 0x00000003
///* [0x10]: REG BPM sensitivity (Y axis) parameter register */
//#define POS_CALC_REG_KY 0x00000004
///* [0x14]: REG BPM sensitivity (Sum) parameter register */
//#define POS_CALC_REG_KSUM 0x00000005
///* [0x18]: REG DSP TBT incorrect TDM counter */
//#define POS_CALC_REG_DSP_CTNR_TBT 0x00000006
///* [0x1c]: REG DSP FOFB incorrect TDM counter */
//#define POS_CALC_REG_DSP_CTNR_FOFB 0x00000007
///* [0x20]: REG DSP Monit. incorrect TDM counter part 1 */
//#define POS_CALC_REG_DSP_CTNR1_MONIT 0x00000008
///* [0x24]: REG DSP Monit. incorrect TDM counter part 2 */
//#define POS_CALC_REG_DSP_CTNR2_MONIT 0x00000009
///* [0x28]: REG DSP error clearing */
//#define POS_CALC_REG_DSP_ERR_CLR 0x0000000a
///* [0x2c]: REG DDS general config registers for all channels */
//#define POS_CALC_REG_DDS_CFG 0x0000000b
///* [0x30]: REG DDS phase increment parameter register for channel 0 */
//#define POS_CALC_REG_DDS_PINC_CH0 0x0000000c
///* [0x34]: REG DDS phase increment parameter register for channel 1 */
//#define POS_CALC_REG_DDS_PINC_CH1 0x0000000d
///* [0x38]: REG DDS phase increment parameter register for channel 2 */
//#define POS_CALC_REG_DDS_PINC_CH2 0x0000000e
///* [0x3c]: REG DDS phase increment parameter register for channel 3 */
//#define POS_CALC_REG_DDS_PINC_CH3 0x0000000f
///* [0x40]: REG DDS phase offset parameter register for channel 0 */
//#define POS_CALC_REG_DDS_POFF_CH0 0x00000010
///* [0x44]: REG DDS phase offset parameter register for channel 1 */
//#define POS_CALC_REG_DDS_POFF_CH1 0x00000011
///* [0x48]: REG DDS phase offset parameter register for channel 2 */
//#define POS_CALC_REG_DDS_POFF_CH2 0x00000012
///* [0x4c]: REG DDS phase offset parameter register for channel 3 */
//#define POS_CALC_REG_DDS_POFF_CH3 0x00000013
///* [0x50]: REG Monit. Amplitude Value for channel 0 */
//#define POS_CALC_REG_DSP_MONIT_AMP_CH0 0x00000014
///* [0x54]: REG Monit. Amplitude Value for channel 1 */
//#define POS_CALC_REG_DSP_MONIT_AMP_CH1 0x00000015
///* [0x58]: REG Monit. Amplitude Value for channel 2 */
//#define POS_CALC_REG_DSP_MONIT_AMP_CH2 0x00000016
///* [0x5c]: REG Monit. Amplitude Value for channel 3 */
//#define POS_CALC_REG_DSP_MONIT_AMP_CH3 0x00000017
///* [0x60]: REG Monit. X Position Value */
//#define POS_CALC_REG_DSP_MONIT_POS_X 0x00000018
///* [0x64]: REG Monit. Y Position Value */
//#define POS_CALC_REG_DSP_MONIT_POS_Y 0x00000019
///* [0x68]: REG Monit. Q Position Value */
//#define POS_CALC_REG_DSP_MONIT_POS_Q 0x0000001a
///* [0x6c]: REG Monit. Sum Position Value */
//#define POS_CALC_REG_DSP_MONIT_POS_SUM 0x0000001b
#endif
