...
/* I2C register */
#define I2C_PRER_LO 0x00 // clock
#define I2C_PRER_HI 0x01
#define I2C_CTR     0x02 // control reg
#define I2C_TXR     0x03 // transmit reg
#define I2C_RXR     0x03 // receive reg (read)
#define I2C_CR      0x04 // command reg
#define I2C_SR      0x04 // status reg (read)
